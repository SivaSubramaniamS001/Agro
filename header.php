...
<div class="wrapper1">	
	<div class="menu">	
				...
				?>
					 ...
					 {
					 ?>
					 <li <?php if($fn=='buyer_register') echo 'class="active"' ?>><a class="hsubs" href="buyer_register.php">USER REGISTRATION</a></li>
					 <li <?php if($fn=='buyer_login') echo 'class="active"' ?>><a class="hsubs" href="buyer_login.php">USER LOGIN</a></li>
                      <li <?php if($fn=='seller_register') echo 'class="active"' ?>><a class="hsubs" href="seller_register.php">FARMER REGISTRATION</a></li>
                      <li <?php if($fn=='seller_login') echo 'class="active"' ?>><a class="hsubs" href="seller_login.php">FARMER LOGIN</a></li>
                      ...
                      <li <?php if($fn=='view_product') echo 'class="active"' ?>><a class="hsubs" href="view_product.php">VIEW PRODUCT</a></li>
                       <li <?php if($fn=='view_seller') echo 'class="active"' ?>><a class="hsubs" href="view_seller.php">VIEW FARMER</a></li>
