...
<div class="wrapper">	
	<div class="main">
		...
		<h3 class="style"><a href="">View Product</a></h3>
          ...
          <tr><td>Category</td><td>Product name</td><td>Product Description</td><td>Product image</td><td>Price</td><td>Quantity</td><td>Date</td><td>Action</td></tr>
          <?php
		  $sid=$_SESSION['sid'];
		  if($sid!='')
		  {
...
echo "<tr><td>$cat</td><td>$pname</td><td>$pdescp</td><td><img src='upload/$pimage' width='100px' /></td><td>$price</td><td>$qty</td><td>$date</td><td><a href='view_product.php?pid=$pid'>Delete</a></td></tr>";
				}
				?>
                </table>
