...
$price=$y['price'];
	...
	$dist=$j['dist'];	
		if($m!=0)
		{
echo "<tr><td>Username:$username <br/>Mobileno:$mobileno<br/>Address:$address<br/>Pinno:$pinno<br/>Dist:$dist<br/></td><td><img src='upload/$pimage' height='50px' /></td><td>$pname</td><td>$pdescp</td><td>$price</td><td>$qty</td><td>$tot</td><td>$date</td><td><a href='invoice.php?cid=$cid'>Delete</a></td></tr>";
}
if($m==0)
{
