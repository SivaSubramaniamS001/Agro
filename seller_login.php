...
$username=mysql_real_escape_string($_POST['username']);
	...
	$_SESSION['sid']=$n['sid'];
	echo "<script type='text/javascript'>alert('Farmer Logged in successful');</script>";
	echo '<meta http-equiv="refresh" content="0;url=seller_profile.php">';
	
	}
	else{
	echo "<script type='text/javascript'>alert('Farmer account username or  password incorrect!');</script>";
		}
